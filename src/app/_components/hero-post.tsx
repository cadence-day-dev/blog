    ...
    <>
      <section>
        ...
        <div className="md:grid md:grid-cols-2 md:gap-x-16 lg:gap-x-8 mb-20 md:mb-28">
          <div>
            <h3 className="mb-4 text-md lg:text-md leading-tight font-normal uppercase tracking-wider text-white">
              <Link href={`/posts/${slug}`} className="hover:underline text-white">
                {title}
              </Link>
            </h3>
            <div className="mb-4 md:mb-0 text-sm tracking-wider text-white">
              <DateFormatter dateString={date} />
            </div>
          </div>
          <div>
            <p className="text-md leading-relaxed mb-4 tracking-wider text-white">{excerpt}</p>
